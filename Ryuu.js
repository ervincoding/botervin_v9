...
📱 _*Nomor*_ : @${sender.split('@')[0]}`
 Sendbutdocument(from, tescok, "Bot Zick | Jika Button tidak berfungsi silahkan ketik .listmenu / .allmenu", fs.readFileSync('./media/Walisongo.pdf'),{mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./media/Ryuu.jpg'), filename:`Walisongo.pdf`,pageCount: 999 }, [{buttonId:`${prefix}listmenu`,buttonText:{displayText:'LIST MENU 🌱'},type:1},{buttonId:`${prefix}allmenu`,buttonText:{displayText:'ALL MENU ⛩️'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT 🎥'},type:1}], {quoted:fvid, contextInfo: { mentionedJid: [ptod,dtod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} ${pushname}\nBot Zick | Jika Button tidak berfungsi silahkan ketik ${prefix}listmenu / ${prefix}allmenu`,mediaType:"2",thumbnail:fakeimage,mediaUrl:`https://github.com/`}}})
break
case 'listmenu':
if (isBanned) return reply('Kamu Sudah Di banned!')
